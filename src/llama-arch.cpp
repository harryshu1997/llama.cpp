...
static const std::map<llm_kv, const char *> LLM_KV_NAMES = {
    ...
    { LLM_KV_ATTENTION_SVD_RANKS,                    "%s.attention.svd_ranks"                    },
...
static const std::map<llm_tensor, const char *> LLM_TENSOR_NAMES = {
    ...
    { LLM_TENSOR_ATTN_UK,                                "blk.%d.attn_uk" },
    { LLM_TENSOR_ATTN_UV,                                "blk.%d.attn_uv" },
    { LLM_TENSOR_ATTN_VS,                                "blk.%d.attn_vs" },
...
static const std::map<llm_tensor, llm_tensor_info> LLM_TENSOR_INFOS = {
    ...
    {LLM_TENSOR_ATTN_UK,                    {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_ATTN_UV,                    {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_ATTN_VS,                    {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
